...
const FeedbackCard = ({
    ...
    >
        ...
        <div className='mt-1 flex-1 flex flex-col justify-between'>
            <p className='text-white tracking-wider text-[12px] mb-4'>{testimonial}</p>
...
const Feedbacks = () => {
    return (
        <div className={`mt-12 bg-black-100 rounded-[20px]`}>
            ...
            <div className={`-mt-20 pb-14 ${styles.paddingX} grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-7`}>
